# NSERC Grant Proposal — Free LaTeX Template

[![Open in LetX](https://img.shields.io/badge/Open%20in-LetX-9333EA.svg)](https://letx.app/templates/grants/nserc-grant-proposal)
...
![NSERC Grant Proposal preview](preview.png)
...
Open **[NSERC Grant Proposal on LetX »](https://letx.app/templates/grants/nserc-grant-proposal)** and click *Open as Template* — it compiles in ~1 second, in your browser, free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/nserc-grant-proposal.git
cd nserc-grant-proposal
