...
\Description{A vertical flow chart of four boxes: heterogeneous temporal edges feed a
time-decayed neighbor sampler, then a type-aware attention encoder, which outputs the
embedding.}
\label{fig:arch}
\end{figure}
