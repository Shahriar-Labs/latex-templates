...
\Description{A block diagram. A 50 Hz IMU feeds a gait-phase estimator and then an angular
predictor. The predictor drives a re-alignment policy, which commands the beam steering
controller of the mmWave phased array.}
\label{fig:arch}
\end{figure}
