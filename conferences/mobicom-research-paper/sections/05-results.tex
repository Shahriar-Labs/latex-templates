...
\Description{A line chart of median re-alignment latency in milliseconds against walking
speed for a periodic sweep, an IMU-only Kalman tracker, TrailBeam and a dashed oracle.
Latency rises with speed for every method, and TrailBeam stays closest to the oracle.}
\label{fig:latency}
\end{figure*}
