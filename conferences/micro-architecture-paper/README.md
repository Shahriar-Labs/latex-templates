# MICRO Architecture Paper LaTeX Template
...
## Use it online
Open **[MICRO Architecture Paper on LetX](https://letx.app/templates/conferences/micro-architecture-paper/)** and click *Open as Template*. It is free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/latex-templates.git
cd latex-templates/conferences/micro-architecture-paper
