...
\begin{figure}[t]
  ...
  \Description{A line chart of mining time in seconds against trace length in thousands of
  events for Meridian-Spec and Vertex-Trace. Both grow with trace length, and Meridian-Spec
  stays below Vertex-Trace throughout.}
