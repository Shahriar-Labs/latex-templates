# User Acceptance Testing (UAT) Plan — Free LaTeX Template

[![Open in LetX](https://img.shields.io/badge/Open%20in-LetX-9333EA.svg)](https://letx.app/templates/tech-docs/uat-test-plan)
...
![User Acceptance Testing (UAT) Plan preview](preview.png)
...
Open **[User Acceptance Testing (UAT) Plan on LetX »](https://letx.app/templates/tech-docs/uat-test-plan)** and click *Open as Template* — it compiles in ~1 second, in your browser, free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/uat-test-plan.git
cd uat-test-plan
