# API Documentation (Swagger Style) — Free LaTeX Template

[![Open in LetX](https://img.shields.io/badge/Open%20in-LetX-9333EA.svg)](https://letx.app/templates/tech-docs/api-documentation-swagger)
...
![API Documentation (Swagger Style) preview](preview.png)
...
Open **[API Documentation (Swagger Style) on LetX »](https://letx.app/templates/tech-docs/api-documentation-swagger)** and click *Open as Template* — it compiles in ~1 second, in your browser, free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/api-documentation-swagger.git
cd api-documentation-swagger
