...
[![Open in LetX](https://img.shields.io/badge/Open%20in-LetX-9333EA.svg)](https://letx.app/templates/finance/form-s-1-filing)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Compile Tested](https://img.shields.io/badge/Compile-Tested-success.svg)](#compile)

**Regulatory Filing (Form S-1) LaTeX template — Regulatory Filing (Form S-1). Elegant, compile-tested, editable online at letx.app.**
...
![Regulatory Filing (Form S-1) preview](preview.png)
...
```bash
git clone https://github.com/Shahriar-Labs/form-s-1-filing.git
cd form-s-1-filing
