  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=north west,white] at ([xshift=28pt,yshift=-102pt]current page.north west){%
      \begin{minipage}{0.85\paperwidth}
        ...
        {\large\textcolor{gold}{NXSC \textbar\ Meridex\enspace\textbar\enspace Semiconductors}}\\[10pt]
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.55\textwidth}
      ...
      \begin{tabularx}{\linewidth}{@{}>{\color{navy}\bfseries\footnotesize}l@{\hspace{7mm}}>{\raggedright\arraybackslash\footnotesize}X@{}}
        Ticker / Exchange       & NXSC \textbar\ Meridex \\
        Share Price             & \$42.50 \\
    ...
    \column{0.50\textwidth}
      \begin{tikzpicture}[scale=0.92]
        ...
        \foreach \y/\col/\label/\date/\detail in {
          ...
          -4.8/gold/Hansol P3 Award/Mar 2027/Competitive win vs.\ Lam Research — \$240M TAM,
...
\begin{frame}{Valuation Waterfall}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.48\textwidth}
      ...
      \vspace{4pt}
      {\footnotesize\color{dtext!70}\faLightbulb\hspace{4pt} Bear case assumes delayed 3nm ramp + TI fab cancellation. Bull case assumes sole-source win at Corex 18A.}
  \end{columns}
...
\begin{frame}{Risk Matrix \& Position Management}
  ...
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash\footnotesize}X@{\hspace{4mm}}c@{\hspace{4mm}}c@{\hspace{4mm}}>{\raggedright\arraybackslash\footnotesize}X@{}}
    ...
    \addlinespace[3pt]
    Customer consolidation (SK Hynix + Hansol merger) &
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \begin{alertblock}{Key Monitor Items}
        ...
        \faCheckSquare\hspace{4pt} Hansol P3 tool award (Q1 2027)
        }
      \end{alertblock}
  \end{columns}
