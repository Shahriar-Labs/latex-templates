# Root Cause Analysis Report — Free LaTeX Template

[![Open in LetX](https://img.shields.io/badge/Open%20in-LetX-9333EA.svg)](https://letx.app/templates/engineering/root-cause-analysis-report)
...
![Root Cause Analysis Report preview](preview.png)
...
Open **[Root Cause Analysis Report on LetX »](https://letx.app/templates/engineering/root-cause-analysis-report)** and click *Open as Template* — it compiles in ~1 second, in your browser, free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/root-cause-analysis-report.git
cd root-cause-analysis-report
