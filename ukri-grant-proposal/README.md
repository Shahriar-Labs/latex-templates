# UKRI Grant Proposal — Free LaTeX Template
...
Open **[UKRI Grant Proposal on LetX »](https://letx.app/templates/grants/ukri-grant-proposal)** and click *Open as Template* — it compiles in ~1 second, in your browser, free.

## <a name="compile"></a>Compile locally
```bash
git clone https://github.com/Shahriar-Labs/ukri-grant-proposal.git
cd ukri-grant-proposal
